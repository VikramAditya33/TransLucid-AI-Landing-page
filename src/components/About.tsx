          ...
          <div className="mx-auto max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a 
                ...
                className="flex items-center gap-3 px-6 py-3 rounded-lg border border-black/10 bg-white hover:bg-black/5 dark:bg-black/20 dark:hover:bg-black/30 transition-colors"
              >
              ...
              <a 
                href="https://github.com/VikramAditya33" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-6 py-3 rounded-lg border border-black/10 bg-white hover:bg-black/5 dark:bg-black/20 dark:hover:bg-black/30 transition-colors"
              >
              ...
              <a 
                href="https://www.linkedin.com/in/vikram-aditya-verma-b80561367" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-6 py-3 rounded-lg border border-black/10 bg-white hover:bg-black/5 dark:bg-black/20 dark:hover:bg-black/30 transition-colors"
              >
